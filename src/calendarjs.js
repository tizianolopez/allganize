...
function calendarJs( id, options, startDateTime ) {
    ...
    function buildDefaultOptions( newOptions ) {
        ...
        if ( !isDefined( _options.eventTooltipDelay ) ) {
            _options.eventTooltipDelay = 200;
        }
    ...
    function setTranslationStringOptions() {
        if ( !isDefined( _options.previousMonthTooltipText ) ) {
            _options.previousMonthTooltipText = "Mes Anterior";
        }

        if ( !isDefined( _options.nextMonthTooltipText ) ) {
            _options.nextMonthTooltipText = "Siguiente Mes";
        }

        if ( !isDefined( _options.previousDayTooltipText ) ) {
            _options.previousDayTooltipText = "Día Anterior";
        }

        if ( !isDefined( _options.nextDayTooltipText ) ) {
            _options.nextDayTooltipText = "Sigiente Día";
        }
        ...
        if ( !isDefined( _options.addEventTooltipText ) ) {
            _options.addEventTooltipText = "Nuevo Evento";
        }

        if ( !isDefined( _options.closeTooltipText ) ) {
            _options.closeTooltipText = "Cerrar";
        }

        if ( !isDefined( _options.exportEventsTooltipText ) ) {
            _options.exportEventsTooltipText = "Exportar Eventos";
        }

        if ( !isDefined( _options.todayTooltipText ) ) {
            _options.todayTooltipText = "Hoy";
        }

        if ( !isDefined( _options.refreshTooltipText ) ) {
            _options.refreshTooltipText = "Refrescar";
        }

        if ( !isDefined( _options.searchTooltipText ) ) {
            _options.searchTooltipText = "Buscar";
        }

        if ( !isDefined( _options.expandDayTooltipText ) ) {
            _options.expandDayTooltipText = "Expandir Día";
        }

        if ( !isDefined( _options.listAllEventsTooltipText ) ) {
            _options.listAllEventsTooltipText = "Todos los Eventos";
        }

        if ( !isDefined( _options.listWeekEventsTooltipText ) ) {
            _options.listWeekEventsTooltipText = "Eventos Semanales";
        }
        ...
        if ( !isDefined( _options.addEventTitle ) ) {
            _options.addEventTitle = "Nuevo Evento";
        }
        ...
        if ( !isDefined( _options.fromTimeErrorMessage ) ) {
            _options.fromTimeErrorMessage = "Por favor seleccione un tiempo de Inicio valido.";
        }

        if ( !isDefined( _options.toTimeErrorMessage ) ) {
            _options.toTimeErrorMessage = "Por favor seleccione un tiempo de Fin valido.";
        }

        if ( !isDefined( _options.toSmallerThanFromErrorMessage ) ) {
            _options.toSmallerThanFromErrorMessage = "Por favor elija un tiempo de fin superior al tiempo de inicio.";
        }

        if ( !isDefined( _options.titleErrorMessage ) ) {
            _options.titleErrorMessage = "Por favor seleccione un 'Título'";
        }
        ...
        if ( !isDefined( _options.toTimeText ) ) {
            _options.toTimeText = "hasta";
        }
        
        if ( !isDefined( _options.confirmEventRemoveTitle ) ) {
            _options.confirmEventRemoveTitle = "Confirmación de eliminacion";
        }
        
        if ( !isDefined( _options.confirmEventRemoveMessage ) ) {
            _options.confirmEventRemoveMessage = "Quitar este evento no puede ser deshecho.  ¿Desea continuar?";
        }
        ...
        if ( !isDefined( _options.selectColorsText ) ) {
            _options.selectColorsText = "Elija Colores";
        }
        
        if ( !isDefined( _options.backgroundColorText ) ) {
            _options.backgroundColorText = "Color del Fondo:";
        }
        
        if ( !isDefined( _options.textColorText ) ) {
            _options.textColorText = "Color del Texto:";
        }
        
        if ( !isDefined( _options.borderColorText ) ) {
            _options.borderColorText = "Color del Borde:";
        }
        
        if ( !isDefined( _options.searchEventsTitle ) ) {
            _options.searchEventsTitle = "Buscar Eventos";
        }
        ...
        if ( !isDefined( _options.nextText ) ) {
            _options.nextText = "Siguiente";
        }
        
        if ( !isDefined( _options.matchCaseText ) ) {
            _options.matchCaseText = "Mismo tipo";
        }
        
        if ( !isDefined( _options.repeatsText ) ) {
            _options.repeatsText = "Repetir:";
        }
        
        if ( !isDefined( _options.repeatDaysToExcludeText ) ) {
            _options.repeatDaysToExcludeText = "Excluir Día de Repetición:";
        }
        
        if ( !isDefined( _options.daysToExcludeText ) ) {
            _options.daysToExcludeText = "Días Excluidos:";
        }
        
        if ( !isDefined( _options.seriesIgnoreDatesText ) ) {
            _options.seriesIgnoreDatesText = "Ignorar Fechas:";
        }
        ...
        if ( !isDefined( _options.repeatsEveryDayText ) ) {
            _options.repeatsEveryDayText = "Todos los Días";
        }
        
        if ( !isDefined( _options.repeatsEveryWeekText ) ) {
            _options.repeatsEveryWeekText = "Cada Semana";
        }

        if ( !isDefined( _options.repeatsEvery2WeeksText ) ) {
            _options.repeatsEvery2WeeksText = "Cada 2 Semanas";
        }
        
        if ( !isDefined( _options.repeatsEveryMonthText ) ) {
            _options.repeatsEveryMonthText = "Cada Mes";
        }
        
        if ( !isDefined( _options.repeatsEveryYearText ) ) {
            _options.repeatsEveryYearText = "Cada Año";
        }

        if ( !isDefined( _options.repeatsCustomText ) ) {
            _options.repeatsCustomText = "Personalizado:";
        }
        
        if ( !isDefined( _options.repeatOptionsTitle ) ) {
            _options.repeatOptionsTitle = "Opciones";
        }
        
        if ( !isDefined( _options.moreText ) ) {
            _options.moreText = "Más";
        }
        
        if ( !isDefined( _options.includeText ) ) {
            _options.includeText = "Incluye:";
        }
        
        if ( !isDefined( _options.minimizedTooltipText ) ) {
            _options.minimizedTooltipText = "Minimizar";
        }
        ...
        if ( !isDefined( _options.removeAllEventsInSeriesText ) ) {
            _options.removeAllEventsInSeriesText = "Quitar todos los eventos de la serie";
        }
        
        if ( !isDefined( _options.createdText ) ) {
            _options.createdText = "Creado:";
        }
        
        if ( !isDefined( _options.organizerNameText ) ) {
            _options.organizerNameText = "Nombre:";
        }
        
        if ( !isDefined( _options.organizerEmailAddressText ) ) {
            _options.organizerEmailAddressText = "Correo Electronico:";
        }
        
        if ( !isDefined( _options.enableFullScreenTooltipText ) ) {
            _options.enableFullScreenTooltipText = "Activar Pantalla Completa";
        }
        
        if ( !isDefined( _options.disableFullScreenTooltipText ) ) {
            _options.disableFullScreenTooltipText = "Quitar Pantalla Completa";
        }
        ...
        if ( !isDefined( _options.expandMonthTooltipText ) ) {
            _options.expandMonthTooltipText = "Expandir Mes";
        }
        
        if ( !isDefined( _options.repeatEndsText ) ) {
            _options.repeatEndsText = "Fin de la repetición:";
        }
        
        if ( !isDefined( _options.noEventsAvailableText ) ) {
            _options.noEventsAvailableText = "Sin eventos disponibles.";
        }
        
        if ( !isDefined( _options.viewWeekEventsText ) ) {
            _options.viewWeekEventsText = "Eventos Semanales";
        }
        
        if ( !isDefined( _options.noEventsAvailableFullText ) ) {
            _options.noEventsAvailableFullText = "No hay eventos disponibles para ver.";
        }
        ...
        if ( !isDefined( _options.hereText ) ) {
            _options.hereText = "aquí";
        }
        
        if ( !isDefined( _options.toAddANewEventText ) ) {
            _options.toAddANewEventText = "para agregar un nuevo evento.";
        }
        ...
        if ( !isDefined( _options.groupText ) ) {
            _options.groupText = "Grupo:";
        }
        
        if ( !isDefined( _options.configurationTooltipText ) ) {
            _options.configurationTooltipText = "Configuración";
        }
        
        if ( !isDefined( _options.configurationTitleText ) ) {
            _options.configurationTitleText = "Configuración";
        }
        
        if ( !isDefined( _options.groupsTabText ) ) {
            _options.groupsTabText = "Grupos";
        }
        ...
        if ( !isDefined( _options.eventNotificationBody ) ) {
            _options.eventNotificationBody = "El evento '{0}' empieza ahora.";
        }

        if ( !isDefined( _options.optionsText ) ) {
            _options.optionsText = "Opciones:";
        }

        if ( !isDefined( _options.startsWithText ) ) {
            _options.startsWithText = "Comienza en...";
        }

        if ( !isDefined( _options.endsWithText ) ) {
            _options.endsWithText = "Termina en...";
        }
        ...
        if ( !isDefined( _options.enableAutoRefreshForEventsText ) ) {
            _options.enableAutoRefreshForEventsText = "Auto-refresh para eventos";
        }

        if ( !isDefined( _options.enableBrowserNotificationsText ) ) {
            _options.enableBrowserNotificationsText = "Notificaciones de buscador";
        }

        if ( !isDefined( _options.enableTooltipsText ) ) {
            _options.enableTooltipsText = "Etiqueta de herramientas";
        }

        if ( !isDefined( _options.dayText ) ) {
            _options.dayText = "día";
        }

        if ( !isDefined( _options.daysText ) ) {
            _options.daysText = "días";
        }

        if ( !isDefined( _options.hourText ) ) {
            _options.hourText = "hora";
        }

        if ( !isDefined( _options.hoursText ) ) {
            _options.hoursText = "horas";
        }
        ...
        if ( !isDefined( _options.minutesText ) ) {
            _options.minutesText = "minutos";
        }

        if ( !isDefined( _options.enableDragAndDropForEventText ) ) {
            _options.enableDragAndDropForEventText = "Permitir arrastrar y soltar eventos";
        }

        if ( !isDefined( _options.organizerTabText ) ) {
            _options.organizerTabText = "Organizate";
        }

        if ( !isDefined( _options.removeEventsTooltipText ) ) {
            _options.removeEventsTooltipText = "Quitar Eventos";
        }

        if ( !isDefined( _options.confirmEventsRemoveTitle ) ) {
            _options.confirmEventsRemoveTitle = "Confirmar eliminacion de eventos";
        }
        
        if ( !isDefined( _options.confirmEventsRemoveMessage ) ) {
            _options.confirmEventsRemoveMessage = "Remover estos eventos no puede deshacerse.  ¿Desea continuar?";
        }
        ...
        if ( !isDefined( _options.optionalText ) ) {
            _options.optionalText = "Opcional";
        }
        ...
        if ( !isDefined( _options.openUrlText ) ) {
            _options.openUrlText = "Abrir Url";
        }

        if ( !isDefined( _options.visibleDaysTabText ) ) {
            _options.visibleDaysTabText = "Días Visibles";
        }

        if ( !isDefined( _options.enableDayNameHeadersInMainDisplayText ) ) {
            _options.enableDayNameHeadersInMainDisplayText = "Permitir ver los días en la cabecera";
        }

        if ( !isDefined( _options.thisWeekTooltipText ) ) {
            _options.thisWeekTooltipText = "Esta Semana";
        }

        if ( !isDefined( _options.dailyText ) ) {
            _options.dailyText = "Diario";
        }

        if ( !isDefined( _options.weeklyText ) ) {
            _options.weeklyText = "Semanal";
        }

        if ( !isDefined( _options.monthlyText ) ) {
            _options.monthlyText = "Mensual";
        }

        if ( !isDefined( _options.yearlyText ) ) {
            _options.yearlyText = "Anual";
        }
        ...
        if ( !isDefined( _options.advancedText ) ) {
            _options.advancedText = "Avanzado";
        }

        if ( !isDefined( _options.copyText ) ) {
            _options.copyText = "Copiar";
        }

        if ( !isDefined( _options.pasteText ) ) {
            _options.pasteText = "Pegar";
        }

        if ( !isDefined( _options.duplicateText ) ) {
            _options.duplicateText = "Duplicar";
        }

        if ( !isDefined( _options.showAlertsText ) ) {
            _options.showAlertsText = "Mostrar Alertas";
        }

        if ( !isDefined( _options.selectDatePlaceholderText ) ) {
            _options.selectDatePlaceholderText = "Seleccionar fecha...";
        }

        if ( !isDefined( _options.hideDayText ) ) {
            _options.hideDayText = "Esconder Día";
        }
    }
